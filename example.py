...
qm_software = {'code': ConditionalQuestion("code",
            ...
            {'qchem': gaussian, 'gaussian': gaussian}),
            'qmmm': {
...
#    q, sh =  questions._get_question_block(questions.questions, "sh::code(qchem)")
#    print(q.get("code").get("qchem"))
#    set_answers_from_config(questions, "extrue2.ini")
    questions.ask("extrue3.ini")
